# Careva — Online doctor appointments
...
[![Live demo — Netlify](https://img.shields.io/badge/Live_demo-Netlify-00C7B7?logo=netlify)](#) <!-- TODO: replace with Careva's live deployment URL once hosted -->
...
```
careva/                      ← React app (run from here with npm start)
...
<!-- TODO: add a fresh Careva screenshot here -->
<!-- ![Careva overview](path/to/screenshot.png) -->
...
- **GitHub:** [github.com/BT-Rajan](https://github.com/BT-Rajan)  
- **Email:** [rajan@careva.com](mailto:rajan@careva.com)
